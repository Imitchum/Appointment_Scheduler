...
public class CustomersDAO {
    ...
    public static ObservableList<Customers> getAssociatedAppointments()
    {
        ObservableList<Customers> customers = FXCollections.observableArrayList();
        try{
            String sql = "SELECT Customer_ID FROM customers, appointments WHERE customers.Customer_ID = appointments.Customer_ID ";
